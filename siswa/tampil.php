...
<div class="container-fluid ps-4 pt-3 pe-4 align-top">
	...
	$no = 1;
    // create pagination
    $result = $db->select_data("select * from siswa");
    $limit = 10;
    ...
    if (isset($_POST['cari'])) {
        ...
        $result = $db->select_data("select * from siswa where nama_lengkap like '%$keyword%' or nis like '%$keyword%'");
    } else {
        $result = $db->select_data("select * from siswa limit $awal, $limit");
    }
	foreach($result as $x):
	?>
            <tr>
